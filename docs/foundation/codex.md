...
- antes de fechar cada PR, sincronizar `docs/foundation/codex.md`, `docs/foundation/roadmap.md`, `docs/foundation/master_schema.md` e `docs/planning/execution_matrix.md` se o estado real do projeto tiver mudado
...
- `docs/`: documentacao operacional local da workspace
- `index.html`: launcher offline simples na raiz do workspace
- `dashboard.zsh`: launcher HTTP local para uso via terminal
- `docs/ops/RUN_LOCAL.md`: guia de execucao e teste humano
- `docs/ops/MEGA_MVP_HANDOFF.md`: estado atual, limites e lacunas prioritarias
- `docs/foundation/master_schema.md`: schema operacional por Part e por superficie
- `docs/planning/execution_matrix.md`: backlog operacional priorizado
...
- `docs/foundation/codex.md` e `docs/foundation/roadmap.md`: guias operacionais locais
...
- Parts 1, 2, 3 e 5 agora tambem tiveram suas masterclasses puxadas para a mesma logica de `real first`, reduzindo a dependencia de mural de SVGs e reforcando dispositivo, imagem e custo biologico no mundo real
- Parts 7, 8 e 9 agora tambem estao mais ancoradas em linha real, manutencao real, territorio hostil real e fecho visual real, com boards mantidos como apoio e nao como camada principal
